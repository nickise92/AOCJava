...
public class DayFour {
     ...
     */
    private static boolean isInRange(String rangeA, String rangeB) {
    ...
    public static int partOne(String inputStr) {
        ...
        while (scanner.hasNextLine()) {
           ...
           if (isInRange(ranges[0], ranges[1])) {           // Check if LeftRange is contained in RightRange
               counter = counter + 1;
           } else if (isInRange(ranges[1], ranges[0])) {    // Check if RightRange is contained in LeftRange
                counter = counter + 1;
            }
        }
